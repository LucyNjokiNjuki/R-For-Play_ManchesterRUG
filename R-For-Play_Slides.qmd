...
format: 
  revealjs:
    ...
    height: 720
    max-scale: 1.5
    footer: "[R For Play Repository](https://github.com/LucyNjokiNjuki/R-For-Play_ManchesterRUG)"
...
**Aim:** To engage with the global R community by curating the @WeAreRLadies account, sharing resources, ideas, and projects that encourage creativity and confidence in using R. I wanted to highlight how diverse the R world can be, and spark new connections through conversation.

- I had the chance to curate **[WeAreRLadies](https://bsky.app/profile/weare.rladies.org)**, the rotating Bluesky account that features R users worldwide. 
